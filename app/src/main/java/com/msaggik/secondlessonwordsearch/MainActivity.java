...
public class MainActivity extends AppCompatActivity {
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            String resultSearch = searchMapPoem(searchText, mapPoem); // поиск String searchText в мап
    ...
    private String searchMapPoem(String search, Map<Integer, String> map) {
        ...
        for (Integer key: map.keySet()) {
            if(map.get(key).length() == searchAsNumber) {
                count++;
                result = result + "\n\n" + map.get(key);
            }
        }
        ...
        if (count == 0) {
            ...
            return count + " упоминаний введённой фразы в следующих строках:" + result; // вывод количества найденных в поэме фраз и подстрок поэмы, где они были найдены
        }
    }
